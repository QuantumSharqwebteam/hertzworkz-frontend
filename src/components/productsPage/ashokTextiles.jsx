  ...
  return (
    <section className=" font-segoe overflow-y-hidden overflow-x-hidden">
      ...
      <div data-aos="zoom-in" className="p-10 border border-dashed border-orange-500 mx-8  ">
        ...
        <p className="text-lg md:text-xl my-3 text-white">Streamline textile management with Textura. Our web and mobile applications offer inventory tracking, order management, and seamless customer engagement tools, ensuring efficiency across every step of the textile business process.</p>
      </div>
