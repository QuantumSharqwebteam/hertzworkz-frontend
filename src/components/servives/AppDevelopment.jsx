  ...
  const Development = () => {
    return (
        <div className='overflow-x-hidden overflow-y-hidden'>
            ...
            <div data-aos="fade-up" className="flex gap-2 ml-0 mr-[auto] mt-8 sm:mt-[30px] md:mt-[15px] lg:mt-[50px] p-4 sm:p-6 md:p-10 w-full justify-center  h-auto">
          ...
          <div className="flex flex-col mt-10 md:flex-row justify-center items-center md:space-x-6 space-y-6 md:space-y-0 border-y-[1px] border-y-[#222] bg-black p-6 text-white group lg:h-48">
            {/* Card 1 */}
            <div data-aos="fade-right" className="flex flex-col items-center md:items-start text-center md:text-start w-full md:w-1/4 p-5">
            ...
            {/* Card 2 */}
            <div data-aos="fade-up" className="flex flex-col items-center md:items-start text-center md:text-start w-full md:w-1/4 p-5">
              <div className="flex justify-center items-center text-orange-500 bg-[#fe5d26] bg-opacity-[20%] border-[#262626] border-[1px] h-[70px] w-[33%] md:w-[45%] lg:w-[50%] rounded-lg text-2xl mb-2 group-hover:h-[100px] group-hover:w-[55%] duration-300">
            ...
            {/* Card 4 */}
            <div data-aos="fade-left" className="flex flex-col items-center md:items-start text-center md:text-start w-full md:w-1/4 p-5">
              <div className="flex justify-center items-center text-orange-500 bg-[#fe5d26] bg-opacity-[20%] border-[#262626] border-[1px] h-[70px] w-[33%] md:w-[45%] lg:w-[50%] rounded-lg text-2xl mb-2 group-hover:h-[100px] group-hover:w-[55%] duration-300">
          ...
          <p data-aos="flip-up" className="text-center text-neutral-500 text-[18px] sm:text-[20px] md:text-[24px] px-6 sm:px-8 md:px-[50px] leading-8 sm:leading-9 md:leading-10 max-w-[90%] sm:max-w-[1100px] md:max-w-[1300px] mx-auto mt-6 sm:mt-8 md:mt-9 p-6 sm:p-8 md:p-10">
          ...
          <div className='flex flex-col md:flex-row px-8 lg:px-14 mt-8'>
            <img data-aos="fade-right" className='md:w-1/2 md:pr-8' src='/app.svg' alt='app'/>
      ...
      <div data-aos="fade-left" className="space-y-6">
        <div className=" p-3 rounded-lg shadow-md">
          ...
          <p className="text-neutral-500">Define the app's purpose, target audience, and core features. Conduct market research to identify user needs and competition.</p>
        </div>
        <div className=" p-3 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">2. Design</h2>
          <p className="text-neutral-500">Create wireframes and prototypes to visualize the app's layout and user interface. Focus on user experience to ensure intuitive navigation.</p>
        </div>
        <div className=" p-3 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">3. Development</h2>
          <p className="text-neutral-500">This phase includes both front-end and back-end development. Front-end developers work on the user interface, while back-end developers handle server-side logic and database management.</p>
        </div>
        <div className=" text-white p-3 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">4. Testing</h2>
          <p className="text-neutral-500">Conduct rigorous testing to identify and fix bugs, ensuring compatibility across devices and optimizing performance. This includes functional, usability, and security testing.</p>
        </div>
        ...
        <div data-aos="fade-left" className="text-white p-3 rounded-lg shadow-md px-10 lg:px-14 p-3">
          <h2 className="text-xl font-semibold mb-2">5. Deployment</h2>
          <p className="text-neutral-500">Release the app on platforms like Google Play and the Apple App Store. Ensure compliance with their guidelines and prepare for user feedback.</p>
        </div>
        <div data-aos="fade-left" className="text-white p-3 rounded-lg shadow-md px-10 lg:px-14 mb-8">
          <h2 className="text-xl font-semibold mb-2">6. Maintenance and Updates: </h2>
          <p className="text-neutral-500">Continuously monitor the app's performance, address user feedback, and release updates to improve functionality and security.</p>
          </div>
        ...
        <h2 data-aos="fade-up" className="text-3xl sm:text-4xl md:text-5xl text-white font-semibold w-[90%] max-w-[724px] h-auto m-auto text-center">
          <span className="text-[#fe5d26] underline ml-2">D</span>evelopment Services
        </h2>
      
        <div data-aos="fade-right" className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          {/* First Row Group */}
          ...
          {/* Second Row Group */}
          <div data-aos="fade-left" className="col-span-3 group grid grid-cols-1 md:grid-cols-3 gap-6">
            {services
